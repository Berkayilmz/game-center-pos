// src/modules/pos/cari/components/CreditVoucherModal.jsx
import React, { useState } from "react";
import { Formik, Form, Field, ErrorMessage } from "formik";
import * as Yup from "yup";
import "../../inventory/inventory.css";

const CreditVoucherSchema = Yup.object().shape({
...
const CreditVoucherModal = ({ open, onClose, onSave, editItem }) => {
  const [activeTab, setActiveTab] = useState("info");
  if (!open) return null;

  const initialValues = editItem || {
    date: new Date().toISOString().slice(0, 10),
    docNo: `AD-${Date.now().toString().slice(-4)}`,
    dueDate: "",
    amount: "",
    description: "",
    account: "",
    ...
    <div className="modal-overlay">
      <div className="modal-box large">
        ...
        <Formik
          ...
          validationSchema={CreditVoucherSchema}
          onSubmit={(values) => {
            const balance = Number(values.credit) - Number(values.debt || 0);
                    ...
                    <div className="form-row" style={{ marginTop: "10px" }}>
                      ...
                      <Field
                        ...
                        onChange={(e) => {
                          ...
                          setFieldValue("balance", (values.credit || 0) - val);
                        }}
                      />
                    </div>
                    ...
                    <div className="form-row">
                      ...
                      <Field
                        ...
                        onChange={(e) => {
                          ...
                          setFieldValue("balance", val - (values.debt || 0));
                        }}
                      />
                    </div>
              ...
              {activeTab === "notes" && (
                <div className="form-col full-width">
                  ...
                  <Field
                    ...
                    rows="6"
                    className="form-input"
                    placeholder="Alacak dekontuna ait notlar..."
                  />
                </div>
              )}
...
export default CreditVoucherModal;