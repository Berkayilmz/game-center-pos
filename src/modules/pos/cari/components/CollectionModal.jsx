// src/modules/pos/cari/components/CollectionModal.jsx
...
const CollectionModal = ({ open, onClose, onSave, editItem }) => {
  const [activeTab, setActiveTab] = useState("info");
  if (!open) return null;

  const initialValues = editItem || {
    date: new Date().toISOString().slice(0, 10),
    docNo: `COL-${Date.now().toString().slice(-4)}`,
    dueDate: "",
    amount: "",
    description: "",
    account: "",
              ...
              {activeTab === "notes" && (
                <div className="form-col full-width">
                  ...
                  <Field
                    ...
                    rows="6"
                    className="form-input"
                    placeholder="Bu tahsilatla ilgili notlar..."
                  />
                </div>
              )}
